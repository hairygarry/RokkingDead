...
GameSparks.prototype.googleConnectRequest = function(accessToken, code, onResponse )
{
    var request = {};
		//request["accessToken"] = accessToken;
		request["code"] = code;
		request["redirectUri"] = 'http://dead2me.ca';
    gamesparks.sendWithData("GooglePlusConnectRequest", request, onResponse);
}
